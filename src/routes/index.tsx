...
function CourseWorkspace({ course, onBack, onOpenExam }: { course: Course; onBack: () => void; onOpenExam: (code: string) => void }) {
...
function CalendarView({ studySessions = [] }: { studySessions?: PlannedSession[] }) {
